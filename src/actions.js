...
export const RETURN_CURRENT_TRANSACTIONS = "RETURN_CURRENT_TRANSACTIONS";
export const returnCurrentTransactions = (currentTransactions) => ({
  type: RETURN_CURRENT_TRANSACTIONS,
