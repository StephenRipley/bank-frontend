        ...
        <Form>
          ...
          <Form.Group controlId="contract-type">
            ...
            <DropdownButton
              ...
              title={studentLoan}
              name="studentLoan"
              onSelect={event => setStudentLoan(event)}>
              <Dropdown.Item eventKey="NONE">None</Dropdown.Item>
              <Dropdown.Item eventKey="PLAN1">Repayment Plan 1</Dropdown.Item>
              <Dropdown.Item eventKey="PLAN2">Repayment Plan 2</Dropdown.Item>
              <Dropdown.Item eventKey="POSTGRADUATE">Postgraduate Loan</Dropdown.Item>
            </DropdownButton>
          </Form.Group>
